...
class SASRec(torch.nn.Module):
    ...
    def log2feats(self, log_seqs, return_all_layers=False):
        # print(log_seqs)
        ...
        hidden_states = [self.last_layernorm(seqs)] if return_all_layers else []
        ...
        for i in range(len(self.attention_layers)):
            ...
            if return_all_layers:
                hidden_states.append(self.last_layernorm(seqs))

        log_feats = self.last_layernorm(seqs)
        if return_all_layers:
            # hidden_states.append(log_feats)
